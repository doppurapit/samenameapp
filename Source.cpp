...
void graphinit() {
	...
	Graph.koharu[0] = LoadGraph("画像/古河1.png");
	Graph.koharu[1] = LoadGraph("画像/古河2.png");
	...
	Graph.tsukasa[0] = LoadGraph("画像/桐生1.png");
	Graph.tsukasa[1] = LoadGraph("画像/桐生2.png");
	Graph.tsukasa[2] = LoadGraph("画像/桐生3.png");
	Graph.tsukasa[3] = LoadGraph("画像/桐生4.png");
	Graph.tsukasa[4] = LoadGraph("画像/桐生5.png");

	Graph.miria[0] = LoadGraph("画像/赤城1.png");
	Graph.miria[1] = LoadGraph("画像/赤城2.png");
	Graph.miria[2] = LoadGraph("画像/赤城3.png");
	Graph.miria[3] = LoadGraph("画像/赤城4.png");
	Graph.miria[4] = LoadGraph("画像/赤城5.png");

	Graph.nakano[5] = LoadGraph("画像/中野6.png");
	Graph.nakano[6] = LoadGraph("画像/中野7.png");
	Graph.nakano[7] = LoadGraph("画像/中野8.png");
	Graph.nakano[8] = LoadGraph("画像/中野9.png");
	Graph.nakano[9] = LoadGraph("画像/中野10.png");

	Graph.yuuki[0] = LoadGraph("画像/結城1.png");
	Graph.yuuki[1] = LoadGraph("画像/結城2.png");
	Graph.yuuki[2] = LoadGraph("画像/結城3.png");
	Graph.yuuki[3] = LoadGraph("画像/結城4.png");
	Graph.yuuki[4] = LoadGraph("画像/結城5.png");

	Graph.mizuki[0] = LoadGraph("画像/川島1.png");
	Graph.mizuki[1] = LoadGraph("画像/川島2.png");
	Graph.mizuki[2] = LoadGraph("画像/川島3.png");
	Graph.mizuki[3] = LoadGraph("画像/川島4.png");
	Graph.mizuki[4] = LoadGraph("画像/川島5.png");

	Graph.aki[0] = LoadGraph("画像/大和1.png");
	Graph.aki[1] = LoadGraph("画像/大和2.png");
	Graph.aki[2] = LoadGraph("画像/大和3.png");
	Graph.aki[3] = LoadGraph("画像/大和4.png");
	Graph.aki[4] = LoadGraph("画像/大和5.png");

	Graph.mutumi[0] = LoadGraph("画像/氏家1.png");
	Graph.mutumi[1] = LoadGraph("画像/氏家2.png");
	Graph.mutumi[2] = LoadGraph("画像/氏家3.png");
	Graph.mutumi[3] = LoadGraph("画像/氏家4.png");
	Graph.mutumi[4] = LoadGraph("画像/氏家5.png");

	Graph.hajime[0] = LoadGraph("画像/藤原1.png");
	Graph.hajime[1] = LoadGraph("画像/藤原2.png");
	Graph.hajime[2] = LoadGraph("画像/藤原3.png");
	Graph.hajime[3] = LoadGraph("画像/藤原4.png");
	Graph.hajime[4] = LoadGraph("画像/藤原5.png");

	Graph.riina[0] = LoadGraph("画像/多田1.png");
	Graph.riina[1] = LoadGraph("画像/多田2.png");
	Graph.riina[2] = LoadGraph("画像/多田3.png");
	Graph.riina[3] = LoadGraph("画像/多田4.png");
	Graph.riina[4] = LoadGraph("画像/多田5.png");
}
...
void move() {
	...
	case REPORT:
		...
		case 31://北関東編メニュー
			...
			if (Key[KEY_INPUT_RETURN] == 1)
			{
				Report.state = 32 + Report.stateofNO4;//データはstate32～
...
void reportmain() {
	...
	case 40://中野
		...
		{
			DrawString(300, 0, "名前", orange);
			DrawString(300, 40, "中野有香", pink);
			DrawString(300, 80, "駅路線", orange);
			DrawString(300, 120, "わたらせ渓谷鉄道", yellow);
			DrawString(300, 160, "所在地", orange);
			DrawString(300, 200, "群馬県みどり市", yellow);
		}
		else
	...
	case 41://古河
		...
		{
			DrawString(300, 0, "名前", orange);
			DrawString(300, 40, "古賀小春", pink);
			DrawString(300, 80, "駅路線", orange);
			DrawString(300, 120, "宇都宮線", yellow);
			DrawString(300, 160, "所在地", orange);
			DrawString(300, 200, "茨城県古河市", yellow);
		}
		else
		{
			DrawString(300, 450, "Esc:文字情報", yellow);
	...
	case 42://結城
		...
		{
			DrawString(300, 0, "名前", orange);
			DrawString(300, 40, "結城晴,乙倉悠貴", purple);
			DrawString(300, 80, "駅路線", orange);
			DrawString(300, 120, "水戸線", skyblue);
			DrawString(300, 160, "所在地", orange);
			DrawString(300, 200, "茨城県結城市", yellow);
		}
		else
		{
			DrawString(300, 450, "Esc:文字情報", yellow);
	...
	case 43://川島
		...
		{
			DrawString(300, 0, "名前", orange);
			DrawString(300, 40, "川島瑞樹", skyblue);
			DrawString(300, 80, "駅路線", orange);
			DrawString(300, 120, "水戸線", skyblue);
			DrawString(300, 160, "所在地", orange);
			DrawString(300, 200, "茨城県筑西市", yellow);
		}
		else
		{
			DrawString(300, 450, "Esc:文字情報", yellow);
	...
	case 44://大和
		...
		{
			DrawString(300, 0, "名前", orange);
			DrawString(300, 40, "大和亜季", skyblue);
			DrawString(300, 80, "駅路線", orange);
			DrawString(300, 120, "水戸線", skyblue);
			DrawString(300, 160, "所在地", orange);
			DrawString(300, 200, "茨城県桜川市", yellow);
		}
		else
		{
			DrawString(300, 450, "Esc:文字情報", yellow);
	...
	case 45://氏家
		...
		{
			DrawString(300, 0, "名前", orange);
			DrawString(300, 40, "氏家むつみ", skyblue);
			DrawString(300, 80, "駅路線", orange);
			DrawString(300, 120, "宇都宮線", yellow);
			DrawString(300, 160, "所在地", orange);
			DrawString(300, 200, "栃木県さくら市", yellow);
		}
		else
		{
			DrawString(300, 450, "Esc:文字情報", yellow);
	...
	case 46://多田
		...
		{
			DrawString(300, 0, "名前", orange);
			DrawString(300, 40, "多田李衣菜", skyblue);
			DrawString(300, 80, "駅路線", orange);
			DrawString(300, 120, "東武佐野線", yellow);
			DrawString(300, 160, "所在地", orange);
			DrawString(300, 200, "栃木県佐野市", yellow);
		}
		else
		{
			DrawString(300, 450, "Esc:文字情報", yellow);
	...
	case 47://新藤原
		...
		{
			DrawString(300, 0, "名前", orange);
			DrawString(300, 40, "藤原肇", skyblue);
			DrawString(300, 80, "駅路線", orange);
			DrawString(300, 120, "東武鬼怒川線など", yellow);
			DrawString(300, 160, "所在地", orange);
			DrawString(300, 200, "栃木県日光市", yellow);
		}
		else
		{
			DrawString(300, 450, "Esc:文字情報", yellow);
